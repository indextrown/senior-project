        ...
        for url in profile_url_list:
            ...
            while(i < 3):
                ...
                for num, post in enumerate(posts):
                    ...
                    post_contrnts = ' '.join(postinfo[1].text.split())


                    # url
                    post_url = postinfo[0].find_element(By.CSS_SELECTOR, "div > div:nth-child(1) > div:nth-child(1) > div > div:nth-child(2) > div > div:nth-child(3) > a").get_attribute("href")
                    ...
                    if url_gap not in elements:
                        ...
                        if error_srcs:
                            #print(error_srcs)
                            old_titles.append([post_name, post_date, post_contrnts, post_url, error_srcs])
                        else:
                            #print("empty", error_srcs)
                            old_titles.append([post_name, post_date, post_contrnts, post_url, ["NULL"]])
