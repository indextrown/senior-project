...
# ban_list = ["다현, 플라워샵", "정대만", "럭키드로우", "오레오"]
# # 전역 변수 선언
# driver = None
...
#             # 게시시간
#             mytesttime = li[0].find_element(By.CSS_SELECTOR, "div > div > div > div > div:nth-child(2) > div > div:nth-child(3) > a > time").text
    ...
    while (True):
        ...
        for title in titles:
            ...
            try:
                ...
                # 사진 url 
                #photo_url = li[-2].find_element(By.CSS_SELECTOR, " ")
            ...
            # 연속성 파악
            elements = [item[5] for item in old_titles]

            

            # 삽입
            if url_gap not in elements:
                old_titles.append([nickname, user_id, mytesttime, clear_new_title, title_url, url_gap])
